...
* Define project folders: `/core_world`, `/jue_world`, `/dan_world`, `/physics_layer`
...
### **Phase 4: Physics Layer & Cross-Layer Integration**

**Architect Tasks**

* Specify primitive operations (add, sub, mul, div) and atomic operations.
* Specify memory management interface.
* Map cross-layer connections (Core-World → Jue-World → Dan-World → Physics Layer).
...
* Test full system: Jue evaluation → Dan-World modules → Physics Layer primitives.
