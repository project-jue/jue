...
## Physics-World: reality or metaphor?

The physics world is the least specified and the most dangerous.
...
The "Physics-World" is not modeling physical reality—it's providing a minimal computational substrate with explicit constraints. Think of it as:
...
text
Jue-World → Physics-World Contract:
