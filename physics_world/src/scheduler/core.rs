/// Core scheduling logic for the Physics World scheduler
///
/// This module provides the main PhysicsScheduler struct and core scheduling logic,
/// including actor management, message passing, and tick-based execution.
